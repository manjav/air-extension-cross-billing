...
public class Billing
{
	...
	public void init(Activity act, ExtensionContext ctx, String base64EncodedPublicKey, String bindURL, String packageURL)
	{
		_ctx = ctx;
		_helper = new IabHelper(act, base64EncodedPublicKey, bindURL, packageURL);
